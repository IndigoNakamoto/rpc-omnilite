...
A [TypeScript](https://www.typescriptlang.org) library to make RPC and HTTP REST requests to [OmniLite](https://omnilite.org/) and Litecoin Core.
...
## [Bitcion / Litecoin Core RPC](https://bitcoin.org/en/developer-reference#remote-procedure-calls-rpcs)

## [Omnilite RPC](https://github.com/OmniLite/OmniLite/blob/0.18.1/src/omnicore/doc/rpc-api.md)
...
- [`omni_send`](https://github.com/OmniLite/OmniLite/blob/0.18.1/src/omnicore/doc/rpc-api.md#omni_send)
...
- [`omni_senddexsell`](https://github.com/OmniLite/OmniLite/blob/0.18.1/src/omnicore/doc/rpc-api.md#omni_senddexsell)

```javascript
const hash = await client.omni_senddexsell({
  fromaddress: "3M9qvHKtgARhqcMtM5cRT9VaiDJ5PSfQGY",
  propertyidforsale: 1,
  amountforsale: "1.5",
  amountdesired: "0.75",
...
- [`omni_sendnewdexorder`](https://github.com/OmniLite/OmniLite/blob/0.18.1/src/omnicore/doc/rpc-api.md#omni_sendnewdexorder)
...
- [`omni_sendcanceldexorder`](https://github.com/OmniLite/OmniLite/blob/0.18.1/src/omnicore/doc/rpc-api.md#omni_sendcanceldexorder)
...
- [`omni_senddexaccept`](https://github.com/OmniLite/OmniLite/blob/0.18.1/src/omnicore/doc/rpc-api.md#omni_senddexaccept)
...
- [`omni_getinfo`](https://github.com/OmniLite/OmniLite/blob/0.18.1/src/omnicore/doc/rpc-api.md#omni_getinfo)

```javascript
const info = await client.omni_getinfo();
```

- [`omni_getallbalancesforid`](https://github.com/OmniLite/OmniLite/blob/0.18.1/src/omnicore/doc/rpc-api.md#omni_getallbalancesforid)

```javascript
const hex = await client.omni_getallbalancesforid({ propertyid: 321 });
```

- [`omni_getallbalancesforaddress`](https://github.com/OmniLite/OmniLite/blob/0.18.1/src/omnicore/doc/rpc-api.md#omni_getallbalancesforaddress)
