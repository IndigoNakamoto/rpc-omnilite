...
export type SendParams = {fromaddress: string, toaddress: string, propertyid: number, amount: string, redeemaddress?: string, referenceamount?: string}
export type GetBalanceParams = {address: string, propertyid: string}
export type ListTransactionsParams = {txid?: string, count?:number, skip?:number, startblock?:number, endblock?:number}
export type ListBlockTransactionsParams = {index: number}
export type ListBlocksTransactionsParams = {firstblock: number, lastblock: number}
export type ListPendingTransactionsParams = {address?:string}
export type SendDexSellParams = {fromaddress: string, propertyidforsale: number, amountforsale: string, amountdesired: string, paymentwindow: number, minacceptfee: string, action: number}
export type SendNewDexOrderParams = {fromaddress: string, propertyidforsale: number, amountforsale: string, amountdesired: string, paymentwindow: number, minacceptfee: string}
export type SendUpdateDexOrderParams = {fromaddress: string, propertyidforsale: number, amountforsale: string, amountdesired: string, paymentwindow: number, minacceptfee: string}
export type SendCancelDexOrderParams = {fromaddress: string, propertidforsale: number}
export type SendDexAcceptParams = {fromaddress: string, toaddress :string, propertyid: number, amount: string, override: boolean}
export type SendDexPayParams = {fromaddress: string, toaddress: string, propertyid: number, amount: string}
export type SendIssuanceCrowdSaleParams = {fromaddress: string, ecosystem: number, type: number, previousid: number, category: string, subcategory: string, name: string, url: string, data: string, propertyiddesired: number, tokensperunit: string, deadline: number, earlybonus: number, issuerpercentage: number}
export type SendIssuanceFixedParams = {fromaddress: string, ecosystem: number, type: number, previousid: number, category: string, subcategory: string, name: string, url: string, data: string, amount: string}
export type SendIssuanceManagedParams = {fromaddress: string, ecosystem: number, type: number, previousid: number, category: string, subcategory: string, name: string, url: string, data: string}
export type SendStoParams = {fromaddress: string, propertyid: number, amount: string, redeemaddress: string, distributionproperty: number}
export type SendGrantParams = {fromaddress: string, toaddress: string, propertyid: number, amount: string, grantdata?: string}
export type SendRevokeParams = {fromaddress: string, propertyid: number, amount: string, memeo?:string}
export type SendCloseCrowdSaleParams = {fromaddress: string, propertyid: number}
export type SendChangeIssuerParams = {fromaddress: string, toaddress: string, propertyid: number}
export type SendAllParams = {fromaddress: string, toaddress: string, ecosystem: number, redeemaddrss?: string, referenceamount?: string}
export type SendEnableFreezingParams = {fromaddress: string, propertyid: number}
export type SendDisableFreezingParams = {fromaddress: string, propertyid: number}
export type SendFreezeParams = {fromaddrss: string, toaddress: string, propertyid: number, amount: string}
export type SendUnfreezeParams = {fromaddress: string, toaddress: string, propertyid: number, amount: string}
export type SendAnyDataParams = {fromaddress: string, data: string, toaddress: string}
export type SendRawTxParams = {fromaddress: string, rawtransaction: string, referenceaddress?:string, redeemaddress?:string, referenceamount?:string}
export type FundedSendParams = {fromaddress: string, toaddress: string, propertyid: number, amount: string, feeaddress: string}
export type FundedSendAllParams = {fromaddress: string, toaddress: string, ecosystem: number, feeaddress: string}
export type SendNonFungibleParams = {address: string, toaddress: string, propertyid: number, tokenstart: number, tokenend: number, redeemaddress?:string, referenceamount?:string}
export type SetNonFungibleData = {propertyid: number, tokenstart: number, tokenend: number, issuer: boolean, data:string}
export type SendNonFungibleDataParams = {propertyid: number, tokenstart: number, tokenend: number, issuer: boolean, data: string}
...
export type GetNonFungibleTokensParams = {address:string, propertyid?:number}
export type GetNonFungibleTokenDataParams = {propertyid: number, tokenidstart: number, tokenidend: number}
...
export type DecodeTransactionParams = {rawtx:string, prevtxs?:string, height?:string}
...
export type CreateRawTxReferenceParams = {rawtx:string, destination: string, referenceamount?:number}
export type CreateRawTxChangeParams = {rawtx: string, prevtxs: string, destination: string, fee: number, position?:number}
export type CreatePayloadSimpleSendParams = {propertyid: number, amount: string}
export type CreatePayloadSendAllParams = {ecosystem: number}
export type CreatePayloadDexSellParams = {propertyidforsale: number, amountforsale: string, amountdesired: string, paymentwindow: number, minacceptfee: string, action: number}
export type CreatePayloadDexAcceptParams = {propertyid: number, amount: string}
export type CreatePayloadStoParams = {propertyid: number, amount: string, distributionproperty?:number}
export type CreatePayloadIssuanceFixedParams = {ecosystem: number, type: number, previousid: number, category: string, name: string, url: string, data: string, amount: string}
export type CreatePayloadIssuanceCrowdSaleParams = {ecosystem: number, type: number, previousid: number, category: string, subcategory: string, name: string, url: string, data: string, propertyiddesired: number, tokensperunit:string, deadline: number, earlybonus: number, issuerpercentage: number}
export type CreatePayloadIssuanceManagedParams = {ecosystem: number, type: number, previousid: number, category: string, subcategory: string, name: string, url: string, data: string}
export type CreatePayloadCloseCrowdSaleParams = {propertyid: number}
export type CreatePayloadGrantParams = { propertyid: number, amount: string, grantdata?:string}
export type CreatePayloadRevokeParams = {propertyid: number, amount: string, memo?:string}
...
export type CreatePayloadFreezeParams = {toaddress: string, propertyid: number, amount: string}
export type CreatePayloadUnfreezeParams = {toaddrss: string, propertyid: number, amount: string}
export type CreatePayloadAnyDataParams = {data: string}
export type CreatePayloadSendNonFungibleParams = {propertyid: number, tokenstart: number, tokenend: number}
export type CreatePayloadSetNonFungibleDataParams = {propertyid: number, tokenstart: number, tokenend: number, issuer: boolean, data: string}
...
export default class RPCOmnilite extends RPCClient {
    ...
    */
    constructor({
        ...
        super({url, user, pass, port, timeout})
    }
     ...
     */
     omni_createpayload_issuancecrowdsale(params: CreatePayloadIssuanceCrowdSaleParams) {
     ...
     */
     omni_createpayload_issuancemanaged(params:CreatePayloadIssuanceManagedParams) {
     ...
     */
     omni_createpayload_disablefreezing(params: CreatePayloadDisableFreezingParams) {
     ...
     */
     omni_createpayload_sendnonfungible(params: CreatePayloadSendNonFungibleParams) {
     ...
     */
     omni_createpayload_setnonfungibledata(params: CreatePayloadSetNonFungibleDataParams) {
